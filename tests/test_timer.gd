...
func test_create_is_expired_create_and_start_is_not() -> void:
	...
	TTimeManager.FakeTime = 10499.0
	check(not t.Expired, "499 ms")
	TTimeManager.FakeTime = 10500.0
